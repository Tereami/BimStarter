...
namespace PilesCoords
{
    ...
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            string projectName = nameof(PilesCoords);
            RibbonPanel panel = application.CreateRibbonPanel(tabName, $"{projectName} panel");

            string commandName = nameof(PilesNumberingCommand);
            ...
            commandName = nameof(PileCutCommand);
            _ = panel.AddItem(new PushButtonData(
                commandName,
                commandName,
                assemblyPath,
            ...
            commandName = nameof(PilesElevationCommand);
            _ = panel.AddItem(new PushButtonData(
                commandName,
                commandName,
                assemblyPath,
            ...
            commandName = nameof(PilesCalculateRangeCommand);
            _ = panel.AddItem(new PushButtonData(
                commandName,
                commandName,
                assemblyPath,
            ...
            commandName = nameof(SettingsCommand);
            _ = panel.AddItem(new PushButtonData(
                commandName,
                commandName,
                assemblyPath,
